...
namespace
{
	std::array<const char*, static_cast<size_t>(EnemyType::Max)> ENEMY_NAMES = { "dragon", "orc" };
}

AttackEnemyOption::AttackEnemyOption(unsigned int serialisableId)
	: Option(PlayerOptions::AttackEnemy, "Attack Enemy", serialisableId)
{
